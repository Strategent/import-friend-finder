    ...
    render: () => (
      <div className="flex h-full flex-col">
        ...
        <div className="grid grid-cols-2 gap-x-3 gap-y-4">
          ...
          <Mkt
            ticker="Fed speakers"
            val={<span className="text-[14px] text-neutral-400 font-light">None today</span>}
          />
        </div>
      </div>
    ),
  ...
  return (
    <div className="flex gap-3 py-3 border-b border-[#f4f4f4] last:border-b-0">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="text-[12.5px] font-light text-neutral-500 leading-[1.5] mt-0.5">
          {detail}
        </div>
...
function Mkt({
  ...
  const tc =
    tone === "up" ? "text-[#3B6D11]" : tone === "dn" ? "text-[#A32D2D]" : "text-neutral-400";
  return (
    <div>
