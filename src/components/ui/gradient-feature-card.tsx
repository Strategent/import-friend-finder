...
/**
 * GradientFeatureCard — always-dark onboarding card with a deep navy gradient,
 * serif headline, body copy, optional progress bar, and a CTA slot.
 */
  ...
  return (
    <section
      ...
      style={{
        ...
        border: "1px solid var(--spotlight-feature-border)",
        borderRadius: "var(--radius)",
        boxShadow: "var(--spotlight-feature-shadow)",
      }}
    >
      ...
      <div
        ...
        style={{ background: "var(--spotlight-feature-overlay)" }}
      />
