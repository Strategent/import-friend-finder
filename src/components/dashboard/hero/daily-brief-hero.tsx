...
export function DailyBriefHero({
  ...
  return (
    <section className="daily-brief-hero-bg relative min-h-[380px] w-full overflow-hidden rounded-[32px] lg:min-h-[420px]">
      ...
      <div className="absolute bottom-0 right-[5.5%] z-10 hidden h-[77%] w-[33%] overflow-hidden rounded-none bg-white p-8 shadow-[0_-12px_40px_rgba(0,0,0,0.25)] lg:block">
