            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="mt-1.5 h-9 w-full rounded-md border border-border bg-surface-raised px-3 text-[13px] placeholder:text-muted-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-offset-1 focus-visible:ring-offset-background"
                />
              </div>
              <div>
                <label
                ...
                <textarea
                  ...
                  className="mt-1.5 w-full resize-none rounded-md border border-border bg-surface-raised px-3 py-2.5 text-[13px] placeholder:text-muted-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-offset-1 focus-visible:ring-offset-background"
                />
              </div>
