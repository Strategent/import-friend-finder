      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <Card className="bento p-6">
          <div className="flex items-start gap-3">
            ...
            <Button size="sm" variant="outline" className="border-border/60">Invite</Button>
          </div>
          <div className="mt-5 space-y-2">
            {[
              ...
              <div key={u.name} className="flex items-center gap-3 p-2 rounded-lg hover:bg-black/[0.03] dark:hover:bg-white/[0.03]">
                <div className="h-8 w-8 rounded-full grid place-items-center text-[11px] font-semibold" style={{ background: "var(--gradient-primary)" }}>
